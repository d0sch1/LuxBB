...
// The forum is published through a reverse proxy (Cloudflare quick tunnel and/or
// Caddy) that sets X-Forwarded-For. Enable proxy-aware remote address detection so
// that poster IPs, registration IPs and IP bans reflect the real client, not the
// proxy. get_remote_address() (include/functions.php) trusts X-Forwarded-For only
