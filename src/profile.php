...
if ($action == 'change_pass')
{
	if (isset($_GET['key']))
	{
		...
		{
			// activate_string holds a modern bcrypt hash of the new password
	...
	if (isset($_POST['form_sent']))
	{
		...
		$new_password_hash = pun_hash_password($new_password1);
...
else if ($action == 'change_email')
{
	...
	{
		if (!pun_verify_password($_POST['req_password'], $pun_user['password']))
			message($lang_profile['Wrong pass']);
