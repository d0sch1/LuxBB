...
RUN apt-get update && apt-get install -y \
    ...
    && printf '%s\n' '<VirtualHost *:80>' \
        ...
        '    Header set Content-Security-Policy "default-src '\''self'\''; script-src '\''self'\'' https://www.youtube.com '\''unsafe-inline'\'' '\''unsafe-eval'\''; style-src '\''self'\'' '\''unsafe-inline'\''; img-src '\''self'\'' data:; frame-src '\''self'\'' https://www.youtube.com https://www.youtube-nocookie.com; frame-ancestors '\''self'\'';"' \
